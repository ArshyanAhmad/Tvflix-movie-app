...
// RETIURN ONLY TRAILER AND TEASER AS ARRAY
...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&language=en-US&append_to_response=casts,videos,images,releases`, function (movie) {
    ...
    fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=${api_key}&page=1`, addSuggestionMovies)
...
const addSuggestionMovies = function ({ results: movieList }, title) {
...
<div class="slider-list">
    ...
    for (const movie of movieList) {
        const movieCard = createMovieCard(movie) // called from movie_card.html
